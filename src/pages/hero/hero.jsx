...
import "./hero.css";
var headerImg= require("../../media/head-img.png")
const Hero = () => {
  return (
    <>
    ...
    <div class="container flex flex-col px-6 py-4 mx-auto space-y-6 md:h-128 md:py-16 md:flex-row md:items-center md:space-x-6">
        <div class="flex flex-col items-center w-full md:flex-row md:w-1/2">
            ...
            <div class="max-w-lg md:mx-12 md:order-2">
                ...
                <div class="mt-6">
                    <AnchorLink href="#partenar" class="block px-3 py-2 font-semibold text-center text-white transition-colors duration-200 transform bg-blue-500 rounded-md md:inline hover:bg-blue-400">Discover More</AnchorLink>
                </div>
            </div>
        </div>

        <div class="flex items-center justify-center w-full h-100 md:w-1/2 mimi">
        <img class="object-cover w-full h-full max-w-2xl rounded-md mimi" alt='watch' src={headerImg}  />
        </div>
    </div>
</header>
